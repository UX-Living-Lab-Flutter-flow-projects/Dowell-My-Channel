...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF22C969);
  late Color secondary = const Color(0xFFFEFEFE);
  late Color tertiary = const Color(0xFF000000);
  late Color alternate = const Color(0xFF22C969);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFF062309);
  late Color primaryBackground = const Color(0xFFF0F3F6);
