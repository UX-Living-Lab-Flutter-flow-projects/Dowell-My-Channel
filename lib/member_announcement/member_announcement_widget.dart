...
import 'member_announcement_model.dart';
export 'member_announcement_model.dart';

class MemberAnnouncementWidget extends StatefulWidget {
  const MemberAnnouncementWidget({
    Key? key,
    String? announcementType,
  })  : this.announcementType = announcementType ?? 'Member',
        super(key: key);

  final String announcementType;

  @override
  _MemberAnnouncementWidgetState createState() =>
      _MemberAnnouncementWidgetState();
}

class _MemberAnnouncementWidgetState extends State<MemberAnnouncementWidget> {
  late MemberAnnouncementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MemberAnnouncementModel());
