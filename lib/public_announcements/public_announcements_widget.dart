...
import 'public_announcements_model.dart';
export 'public_announcements_model.dart';

class PublicAnnouncementsWidget extends StatefulWidget {
  const PublicAnnouncementsWidget({
    Key? key,
    String? announcementType,
  })  : this.announcementType = announcementType ?? 'Public',
        super(key: key);

  final String announcementType;

  @override
  _PublicAnnouncementsWidgetState createState() =>
      _PublicAnnouncementsWidgetState();
}

class _PublicAnnouncementsWidgetState extends State<PublicAnnouncementsWidget> {
  late PublicAnnouncementsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PublicAnnouncementsModel());
